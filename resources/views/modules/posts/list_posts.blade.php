                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary waves-effect waves-float waves-light" href="{{ url('posts/create') }}" role="button">Add</a>
                            </div>
                           <!--  <div class="card-body">
                                <p class="card-text">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach($value->categories as $cat)
                                                        <span class="badge badge-pill badge-light-success mr-1">{{ $cat->name }}</span>
                                                    @endforeach
                                                </td>
                                                <td>
                                                    @if($value->status == 0) 
                                                        <span class="badge badge-pill badge-light-success mr-1">Draft</span>
                                                    @elseif($value->status == 1)
                                                        <span class="badge badge-pill badge-light-warning mr-1">Published</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{ url('posts/'.encrypt($value->id).'/edit') }}">
                                                                <i data-feather="edit-2" class="mr-50"></i>
                                                                <span>Edit</span>
                                                            </a>
                                                            <a class="dropdown-item" onclick=deletePost({{ $value->id }})>
